...
# Lambda
LAMBDA_FUNCTION_NAME = os.getenv('LAMBDA_FUNCTION_NAME', 'gateway_lambda')
LAMBDA_FUNCTION_ARN = os.getenv('LAMBDA_FUNCTION_ARN')

# IAM Roles
LAMBDA_IAM_ROLE_NAME = os.getenv('LAMBDA_IAM_ROLE_NAME', 'gateway_lambda_iamrole')
GATEWAY_IAM_ROLE_NAME = os.getenv('GATEWAY_IAM_ROLE_NAME', 'agentcore-sample-lambdagateway-role')
...
CLIENT_NAME = os.getenv('COGNITO_CLIENT_NAME', 'sample-agentcore-gateway-client')
RESOURCE_SERVER_ID = os.getenv('COGNITO_RESOURCE_SERVER_ID', 'sample-agentcore-gateway-id')
RESOURCE_SERVER_NAME = os.getenv('COGNITO_RESOURCE_SERVER_NAME', 'sample-agentcore-gateway-name')
