...
try:
    ...
    agent_config_id = os.getenv("LD_AI_CONFIG_ID_MATH", "math-assistant")
    
    logger.info(f"Initializing math-assistant agent with role: {agent_role}")
    
    # Load AI Config prompt with fallback
    MATH_ASSISTANT_SYSTEM_PROMPT, math_ai_tracker, math_ai_config, math_ai_tools = load_ai_agent_prompt(
