...
Usage:
  python3 scripts/fix_agent_role_permissions.py --profile <aws-profile>
"""
# NOTE: This script is unchanged from 2LO — the agent runtime role needs the same
# KB/AOSS/Gateway permissions regardless of 2LO vs 3LO. The 3LO-specific permissions
# (CompleteResourceTokenAuth, GetWorkloadAccessToken) are on the ECS task role and
# gateway service role, not the agent runtime role.
import boto3
import json
import os
import argparse
